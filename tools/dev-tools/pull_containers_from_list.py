#!/bin/python3
# A script to pull every container in a list, in one pass.

import sys # For accessing execution args.
import subprocess # For spinning off docker pushes.
import json # For parsing the pull list.
